...
object KafkaToES {
  def main(args: Array[String]): Unit = {
    ...
    var count: Int = 0
    val esSinkBuilder = new ElasticsearchSink.Builder[CSVToES_Bitcoin](httpHosts, new ElasticsearchSinkFunction[CSVToES_Bitcoin] {
      override def process(element: CSVToES_Bitcoin, runtimeContext: RuntimeContext, requestIndexer: RequestIndexer): Unit = {
        count = count + 1
